...
public class Funcoes {
        ...
        public static void encerrarAluguel(Carro car[], Cliente cl[], Scanner scan) {
        ...
        public static void alugarVeiculo(Carro car[], Cliente cl[], Scanner scan) {
                
                //TODO: Este trecho é idéntico ao de editarCliente. Incorporar em uma função
        ...
        public static void carregarVeiculos(Carro car[]) {
                ...
                try {
                    ...
                    Carro.setTotalCarros(Integer.parseInt(bufferedReader.readLine()));
        ...
        public static void carregarClientes(Cliente cl[]) {
                ...
                try {
                    ...
                    Cliente.setTotalClientes(Integer.parseInt(bufferedReader.readLine()));
        ...
        public static boolean editarCliente(Cliente cl[], Carro car[], Scanner scan) {
                ...
                String resposta="";
                do {
                        System.out.println("Digite o número do cliente a editar:");
                        resposta=scan.nextLine();
                        resposta=resposta.replaceAll("\\D",""); //removo tudo o que não for numérico
                } while (resposta.equals("")); 
